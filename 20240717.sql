...
AND (GONGGEUM_GYEJWA LIKE '%99' OR GONGGEUM_GYEJWA LIKE '%22')
)
...
AND
  GUNGU_CODE = 170
AND
  SUNAPIL BETWEEN '20220101' AND '20221231'
AND
  JIBGYE_CODE = 104000
) A
  UNION ALL
...
GEORAE_GUBUN , JIGEUB_GEORAE , IPGEUM_GEORAE , JO,
                       CASE WHEN R_HOIGYE_YEAR = '2022' AND GEORAE_GUBUN = 61 AND JIGEUB_GEORAE = 1
                      THEN JIGEUB_AMT * JO
                      WHEN R_HOIGYE_YEAR = '2022' AND GEORAE_GUBUN = 61 AND JIGEUB_GEORAE = 2
                      THEN  JIGEUB_AMT * JO
                      WHEN R_HOIGYE_YEAR = '2022' AND GEORAE_GUBUN = 14 AND IPGEUM_GEORAE = 6
                      THEN  -IPGEUM_AMT * JO
                      WHEN R_HOIGYE_YEAR = '2022' AND GEORAE_GUBUN = 14 AND IPGEUM_GEORAE = 7
                      THEN  -IPGEUM_AMT * JO
                      WHEN R_HOIGYE_YEAR = '2022' AND GEORAE_GUBUN = 67 AND JIGEUB_GEORAE = 91
                      THEN  JIGEUB_AMT * JO
                      WHEN R_HOIGYE_YEAR = '2022' AND GEORAE_GUBUN = 67 AND JIGEUB_GEORAE = 93
                      THEN  JIGEUB_AMT * JO
                      ELSE 0 END BAEJEONG
FROM (
                       SELECT
                       ...
                       FROM
                         RPT_GONGGEUM_KEORAE A, RPT_GYEJWA_INFO B, RPT_CODE_INFO C
                       WHERE
                         A.KIJUNIL BETWEEN  '20220101' AND '20221231'
...
WITH GONGGEUM_KEORAE AS (
    ...
    AND GJDT BETWEEN '20220101' AND '20221231'
),
GYEJWA_INFO AS (
    SELECT
    FIL_100_CTNT5 AS GONGGEUM_GYEJWA,
...
SELECT COUNT(*) AS CNT, SUM(JIGEUB_AMT) AS JA
...
FROM GONGGEUM_KEORAE
WHERE KIJUNIL LIKE '2022%'
AND GEUMGO_CODE = 28
AND GUNGU_CODE = 170
AND GEORAE_GUBUN = 17
AND HOIGYE_YEAR = '2022'
AND GONGGEUM_GYEJWA = '02817001100000022'
