[1716272476796
20240521treap1pRPTPWK0215830100

=========================== XDA ID:[tom.ich.rpt.xda.xSelectListICH030303By06]===============================
   ...
   (
                 ...
                 (
                    ...
                    THEN  IPGEUM_AMT * JO ELSE 0 END JEONYONG_IP,
                                      ...
                                      0 AS JEONYONG_JI2,
                                      0 AS JEONYONG_IP2,
                                      CASE WHEN ILJA BETWEEN '00000101' AND '20240315' AND  GEORAE_GUBUN = 11  
                    THEN  IPGEUM_AMT * JO ELSE 0 END TAX_SUNP_IP_AMT3,        
                                               CASE WHEN ILJA BETWEEN '00000101' AND '20240315' AND  GEORAE_GUBUN IN (15,16)
                    THEN  IPGEUM_AMT * JO ELSE 0 END TAX_BAEJUNG_IP_AMT3,               
                                               CASE WHEN ILJA BETWEEN  '00000101' AND '20240315' AND  GEORAE_GUBUN = 64  
        ...
        (
                            ...
                            DECODE(A.IPJI_G,1,A.TRAMT,0) IPGEUM_AMT, DECODE(A.IPJI_G,2,A.TRAMT,0) JIGEUB_AMT,
                                    ...
                                    WHERE  A.GJDT BETWEEN (CASE WHEN A.SIGUMGO_HOIKYE_YR = 9999 THEN '20240101' ELSE '00000101' END) AND '20240315' 
        ...
        (
                      ...
                      DECODE(A.IPJI_G,1,A.TRAMT,0) IPGEUM_AMT, DECODE(A.IPJI_G,2,A.TRAMT,0) JIGEUB_AMT,
                                          ...
                                          CASE WHEN A.SIGUMGO_HOIKYE_YR = 9999 THEN TO_NUMBER(SUBSTR(A.GJDT,1,4))
                                                  ELSE TO_NUMBER(A.SIGUMGO_HOIKYE_YR) END R_HOIGYE_YEAR 
                         FROM ACL_SIGUMGO_SLV A
                         WHERE A.GJDT BETWEEN '20240315' AND '20240315'
                         AND A.SIGUMGO_ORG_C = '28'                         
                         AND A.ICH_SIGUMGO_GUN_GU_C LIKE '0' || '%'
                         AND A.FIL_100_CTNT5 = '02800075690000124'
        )
        ...
        (
                             ...
                             AND KEORAEIL IN (SELECT BIZ_DT FROM MAP_JOB_DATE WHERE DW_BAS_DDT = TO_CHAR(TO_NUMBER(SUBSTR('20240315',0,4)) -1)||'1231')
...
(
      SELECT  GUNGU_CODE, 1 DATA_ROW,
                       0 AMT1,
                       SUM(CASE WHEN JOJEONG_GUBUN = 2 AND IPJI_GUBUN  = 1 AND SUNAPIL = '20240315' THEN NVL(JIBANGSE_AMT,0) * -1
                                            WHEN JOJEONG_GUBUN = 2 AND IPJI_GUBUN  = 2 AND SUNAPIL = '20240315' THEN NVL(JIBANGSE_AMT,0)  ELSE 0 END) AMT2,
                       SUM(CASE WHEN JOJEONG_GUBUN <> 2 AND IPJI_GUBUN = 1 AND SUNAPIL = '20240315' THEN NVL(JIBANGSE_AMT,0)
                                            WHEN JOJEONG_GUBUN <> 2 AND IPJI_GUBUN = 2 AND SUNAPIL = '20240315' THEN NVL(JIBANGSE_AMT,0) * -1  ELSE 0 END) AMT3,
                       0 AMT4,
                       SUM(CASE WHEN JOJEONG_GUBUN = 2 AND IPJI_GUBUN  = 1 AND SUNAPIL = '20240315' THEN NVL(SEWOI_AMT,0) * -1
                                            WHEN JOJEONG_GUBUN = 2 AND IPJI_GUBUN  = 2 AND SUNAPIL = '20240315' THEN NVL(SEWOI_AMT,0)  ELSE 0 END) AMT5,
                       SUM(CASE WHEN JOJEONG_GUBUN <> 2 AND IPJI_GUBUN = 1 AND SUNAPIL = '20240315' THEN NVL(SEWOI_AMT,0)
                                            WHEN JOJEONG_GUBUN <> 2 AND IPJI_GUBUN = 2 AND SUNAPIL = '20240315' THEN NVL(SEWOI_AMT,0) * -1 ELSE 0 END) AMT6,
                       0 AMT7,
                       SUM(CASE WHEN JOJEONG_GUBUN = 2 AND IPJI_GUBUN  = 1 AND SUNAPIL = '20240315' THEN NVL(GYOYUKSE_AMT,0) * -1
                                            WHEN JOJEONG_GUBUN = 2 AND IPJI_GUBUN  = 2 AND SUNAPIL = '20240315' THEN NVL(GYOYUKSE_AMT,0) ELSE 0 END) AMT8,
                       SUM(CASE WHEN JOJEONG_GUBUN <> 2 AND IPJI_GUBUN = 1 AND SUNAPIL = '20240315' THEN NVL(GYOYUKSE_AMT,0)
                                            WHEN JOJEONG_GUBUN <> 2 AND IPJI_GUBUN = 2 AND SUNAPIL = '20240315' THEN NVL(GYOYUKSE_AMT,0) * -1 ELSE 0 END) AMT9,
                       0 AMT10,
                       SUM(CASE WHEN JOJEONG_GUBUN = 2 AND IPJI_GUBUN  = 1 AND SUNAPIL = '20240315' THEN NVL(NONGTEUKSE_AMT,0) * -1
                                            WHEN JOJEONG_GUBUN = 2 AND IPJI_GUBUN  = 2 AND SUNAPIL = '20240315' THEN NVL(NONGTEUKSE_AMT,0) ELSE 0 END) AMT11,
                       SUM(CASE WHEN JOJEONG_GUBUN <> 2 AND IPJI_GUBUN = 1 AND SUNAPIL = '20240315' THEN NVL(NONGTEUKSE_AMT,0)
                                            WHEN JOJEONG_GUBUN <> 2 AND IPJI_GUBUN = 2 AND SUNAPIL = '20240315' THEN NVL(NONGTEUKSE_AMT,0) * -1 ELSE 0 END) AMT12,
                       0 AMT13,
                       ...
                       SUM(CASE WHEN (SUNAPIL BETWEEN '20240315' AND '20240315') AND IPJI_GUBUN = 1 THEN NVL(JIBANGSE_AMT,0)
                                            WHEN (SUNAPIL BETWEEN SUBSTR('20240315',0,6)||'01' AND '20240315') AND IPJI_GUBUN <> 1 THEN NVL(JIBANGSE_AMT,0) * -1 ELSE 0 END) AMT25,
                       SUM(CASE WHEN (SUNAPIL BETWEEN SUBSTR('20240315',0,6)||'01' AND '20240315') AND IPJI_GUBUN =  1 THEN NVL(SEWOI_AMT,0)
                                            WHEN (SUNAPIL BETWEEN SUBSTR('20240315',0,6)||'01' AND '20240315') AND IPJI_GUBUN <> 1 THEN NVL(SEWOI_AMT,0) * -1 ELSE 0 END) AMT26,
                       SUM(CASE WHEN (SUNAPIL BETWEEN SUBSTR('20240315',0,6)||'01' AND '20240315') AND IPJI_GUBUN =  1 THEN NVL(GYOYUKSE_AMT,0)
                                            WHEN (SUNAPIL BETWEEN SUBSTR('20240315',0,6)||'01' AND '20240315') AND IPJI_GUBUN <> 1 THEN NVL(GYOYUKSE_AMT,0) * -1 ELSE 0 END) AMT27,
                       SUM(CASE WHEN (SUNAPIL BETWEEN SUBSTR('20240315',0,6)||'00' AND '20240315') AND IPJI_GUBUN =  1 THEN NVL(NONGTEUKSE_AMT,0)
                                            WHEN (SUNAPIL BETWEEN SUBSTR('20240315',0,6)||'00' AND '20240315') AND IPJI_GUBUN <> 1 THEN NVL(NONGTEUKSE_AMT,0) * -1 ELSE 0 END) AMT28
      FROM  RPT_DANGSEIPJOJEONG A
       WHERE  A.GEUMGO_CODE = '28' 
       AND A.SUNAPIL <= '20240315'
...
============================================================================================
, 1716272476766
20240521treap1pRPTPWK0215830000
...
=========================== XDA ID:[tom.ich.rpt.xda.xSelectOneICH030102By09]===============================
SELECT 
       NVL(MAX(RAH.SNO),0) AS MAX_SNO
FROM RPT_JEONJA_APRV_HIS RAH
WHERE GEUMGO_CODE = '28' 
       AND RAH.PADM_STD_ORG_C = ''
       AND RAH.SL_GMGO_DEPT_C = ''
