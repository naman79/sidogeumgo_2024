SELECT A.HOIGYE_CODE
  ...
  FROM (
      ...
      SELECT A.HOIGYE_CODE, A.HOIGYE_NAME, A.GONGGEUM_GYEJWA, A.GYEJWA_NAME,
       ...
       WHERE A.GONGGEUM_GYEJWA = B.GONGGEUM_GYEJWA
         ...
         AND SUBSTR(NVL(B.MKDT,B.IN_DATE),1,8) <= '20240630'
         AND (B.OUT_DATE IS NULL OR B.OUT_DATE > '20240101' )
         AND (B.HJI_DT IS NULL OR B.HJI_DT > '20240101')
         AND B.BANK_GUBUN = 0
         AND C.KIJUNIL BETWEEN '20240101' AND '20240630'
         AND C.JI_IJA > 0
  ...
  '', '', '', 0, 0, '', A.IJA AS JI_IJA, '160' AS KWA
         ...
         WHERE A.GEUMGO_CODE = '43'
           AND A.GYULSAN_IL IN (SELECT REF_S_NM FROM RPT_CODE_INFO WHERE REF_L_C = 200 AND REF_M_C = 999 AND REF_S_NM BETWEEN '20240101' AND '20240630') 
