...
scsObj.onpageload = function () {
    ...
    rpt.setGridFooterRowDisplay("ICH030307_footer_row", "hide");


    grd_Main.setColumnVisible("DANGWOL_BAEJUNG", false);
	grd_Main.setColumnVisible("BAEJUNG_NUGYE", false);
};
...
/*     if ("9" == sbx_YearGubun.getValue()) {
    ...
    MessageSimpleR01In.set("GOV_G", "0");
    MessageSimpleR01In.set("GUNGU_CD", scsObj.gunC);
...
scsObj.sbm_Search_submitdone = function (e) {
    ...
    if (dlt_Main.getTotalRow() < 1) {
        ...
        rpt.setGridFooterRowDisplay("ICH030307_footer_row", "show");
        scsObj.grdColor();
    }
};
