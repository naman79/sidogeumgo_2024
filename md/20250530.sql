...
FROM (
  ...
  FROM (
    SELECT
     A.ACNO
      , A.GYEJWA_NM
      , SUM(CASE WHEN A.GISDT = B.KEORAEIL AND GG IN ('100000', '110100', '110200', '111300', '120400', '200000', '700000') THEN A.AMT ELSE 0 END) AS 세입_일계
      ...
      , SUM(CASE WHEN A.GISDT = B.KEORAEIL AND A.GG IN ('670090', '670092', '670000') THEN A.AMT ELSE 0 END) AS 일상경비지출_일계
      ...
      , SUM(CASE WHEN A.GISDT = B.KEORAEIL AND A.GG IN ('120700','610002','111100','111200','150000','160000','300000','680000','940000') THEN A.AMT ELSE 0 END) AS MMDA해지_일계 -- 분류 애매해서 임시로 MMDA에 포함 
      ...
      , SUM(CASE WHEN A.GG IN ('100000', '110100', '110200', '111300', '120400', '200000', '700000') THEN A.AMT ELSE 0 END) AS 세입
      ...
      , SUM(CASE WHEN A.GG IN ('670090', '670092', '670000') THEN A.AMT ELSE 0 END) AS 일상경비지출
      ...
      , SUM(CASE WHEN A.GG IN ('120700','610002','111100','111200','150000','160000','300000','680000','940000') THEN A.AMT ELSE 0 END) AS MMDA해지 -- 분류 애매해서 임시로 MMDA에 포함
