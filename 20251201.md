...
-- 동구청 총무과 김현승 고향사랑기금 담당자 변경 + 예금계좌 권한도 추가 요청

SL_GMGO_MODL_C	USER_ID	USER_NM	DISTG	USER_RSA_SCNO	USER_U_C	USER_RIGHT_G	PADM_STD_ORG_C	SL_GMGO_DEPT_C	BR_C	JKGP_NM	USER_TELNO	USER_EMAIL	LST_LOGIN_DT	EMAIL_INF_JEGONG_YN	TEL_INF_JEGONG_YN	PSN_INF_JEGONG_YN	PSN_INF_JEGONG_DTTM	SCNO_CDT	SCNO_INITL_DT	SCNO_INITL_SYS_YN	SCNO_ERR_CNT	USER_IP	USE_YN	PSN_INF_BRWS_YN	DR_DTTM	DROKJA_ID	UPD_DTTM	MODR_ID
RPT	dkdlagus	김현승	0517	1c90b5f2123ab993efdf21d508658347d9b308dc88f8ba7fe6d25a113a83b2e7	028120	2	3500000	3500141		지방행정주사보	01097380719	dkdlagus@korea.kr	20251127	Y	Y	Y	20251127151537	00000000	00000000	N	0	211.253.98.34	Y	Y	20240119105633	35000002019100000016	20251127153239	dkdlagus


select * from rpt_dept_info
where gcc_dept_cd = '3500141'
        ...
        WHERE A.SL_GMGO_MODL_C = 'RPT'               
          AND (A.USER_ID LIKE '%'|| '김현승' ||'%' OR A.USER_NM LIKE '%'|| '김현승' ||'%')
